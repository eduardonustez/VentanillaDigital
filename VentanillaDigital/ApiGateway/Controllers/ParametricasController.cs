...
namespace ApiGateway.Controllers
{
    ...
    public class ParametricasController : BaseController
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ErroresDTO), 400)]
        public async Task<ActionResult<IEnumerable<CategoriaReturnDTO>>> ObtenerCategoriaNotariaVirtual()
        {

            var serviceResponse =
                await _httpClientHelper
                    .ConsumirServicioRest($"{uriAPI}/Parametricas/ObtenerCategoriaNotariaVirtual",
                    HttpMethod.Get, "");
