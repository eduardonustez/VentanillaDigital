...
namespace Infraestructura.ContextoPrincipal.Migrations
{
    ...
    [Migration("20201214211556_Refactor Modelo Usuarios")]
    partial class RefactorModeloUsuarios
    {
            ...
            modelBuilder.Entity("Dominio.ContextoPrincipal.Entidad.Transaccional.Tramite", b =>
                {
                    ...
                    b.Property<DateTime>("Fecha")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 12, 14, 16, 15, 56, 554, DateTimeKind.Local).AddTicks(6622));
            ...
            modelBuilder.Entity("Dominio.ContextoPrincipal.Entidad.Parametricas.NotariaUsuarios", b =>
                {
                    ...
                    b.HasOne("Dominio.ContextoPrincipal.Entidad.Parametricas.Notario", null)
                        .WithOne("NotariaUsuarios")
                        .HasForeignKey("Dominio.ContextoPrincipal.Entidad.Parametricas.NotariaUsuarios", "NotariaUsuariosId")
            ...
            modelBuilder.Entity("Dominio.ContextoPrincipal.Entidad.Parametricas.Notario", b =>
                {
                    b.HasOne("Dominio.ContextoPrincipal.Entidad.Parametricas.Notaria", "Notaria")
                        .WithOne("Notario")
                        .HasForeignKey("Dominio.ContextoPrincipal.Entidad.Parametricas.Notario", "NotarioId")
                        .HasConstraintName("FK_Notarias_Notarios")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
