...
namespace Infraestructura.ContextoPrincipal.Migrations
{
    ...
    [Migration("20210610154400_Campos Estado Dispositivos en Maquina")]
    partial class CamposEstadoDispositivosenMaquina
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dominio.ContextoPrincipal.Entidad.ConvenioNotariaVirtual", b =>
                {
                    ...
                    b.Property<string>("ApiKeySNR")
                        .HasColumnType("varchar(100)")
                        .HasMaxLength(100)
                        .IsUnicode(false);

                    b.Property<string>("ApiUserSNR")
                        .HasColumnType("varchar(100)")
                        .HasMaxLength(100)
                        .IsUnicode(false);

                    b.Property<string>("AutorizacionAutenticacionSNR")
                        .HasColumnType("varchar(100)")
                        .HasMaxLength(100)
                        .IsUnicode(false);
                    ...
                    b.Property<string>("IdNotariaSNR")
                    ...
                    b.Property<string>("SerialCertificado")
                        .HasColumnType("varchar(100)")
                        .HasMaxLength(100)
                        .IsUnicode(false);

                    b.Property<string>("SerialCertificadoNotarioEncargado")
                        .HasColumnType("varchar(100)")
                        .HasMaxLength(100)
                        .IsUnicode(false);

                    b.Property<string>("UrlApiMiFirma")
                        .HasColumnType("varchar(512)")
                        .HasMaxLength(512)
                        .IsUnicode(false);

                    b.Property<string>("UrlSubirDocumentosMiFirma")
            ...
            modelBuilder.Entity("Dominio.ContextoPrincipal.Entidad.Parametricas.Maquina", b =>
                {
                    ...
                    b.Property<string>("EstadoCaptor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EstadoDllWacom")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EstadoWacomSigCaptX")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Dominio.ContextoPrincipal.Entidad.Parametricas.UsuarioTokenPortalAdministrador", b =>
                {
                    b.Property<long>("UsuarioTokenPortalAdministradorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("UsuarioTokenPortalAdministradorId");

                    b.HasIndex("UsuarioAdministracionId", "LoginProvider", "Nombre")
                        .IsUnique();

                    b.ToTable("UsuarioTokenPortalAdministrador","Parametricas");
                });
            ...
            modelBuilder.Entity("Dominio.ContextoPrincipal.Entidad.Transaccional.DocumentoPendienteAutorizar", b =>
                {
                    ...
                    b.Property<bool>("EsFirmaManual")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("EsFirmaManual")
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("Dominio.ContextoPrincipal.Entidad.Transaccional.RecaudoTramiteVirtual", b =>
                {
                    ...
                    b.Property<string>("RespuestaServicio")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Dominio.ContextoPrincipal.Entidad.Transaccional.TramiteCompareciente", b =>
                {
                    b.Property<long>("TramiteComparecienteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("TramiteComparecienteId")
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<long>("ComparecienteId")
                        .HasColumnName("ComparecienteId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("TramiteComparecienteId");

                    b.HasIndex("ComparecienteId");

                    b.HasIndex("TramiteId");

                    b.ToTable("TramitesComparecientes","Transaccional");
                });
            ...
            modelBuilder.Entity("Dominio.ContextoPrincipal.Entidad.Transaccional.TramiteCompareciente", b =>
                {
                    b.HasOne("Dominio.ContextoPrincipal.Entidad.Transaccional.Compareciente", "Compareciente")
                        .WithMany("TramiteCompareciente")
                        .HasForeignKey("ComparecienteId")
                        .HasConstraintName("FK_TramitesComparecientes_Comparecientes")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Dominio.ContextoPrincipal.Entidad.Transaccional.Tramite", "Tramite")
                        .WithMany("TramiteCompareciente")
                        .HasForeignKey("TramiteId")
                        .HasConstraintName("FK_TramitesComparecientes_Tramites")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
