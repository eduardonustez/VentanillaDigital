...
namespace Infraestructura.ContextoPrincipal.Migrations
{
    ...
    [Migration("20201204153305_updateStoreProcedure-[Transaccional].[TramitesPendientes_Obtener]")]
    partial class updateStoreProcedureTransaccionalTramitesPendientes_Obtener
    {
            ...
            modelBuilder.Entity("Dominio.ContextoPrincipal.Entidad.Transaccional.Tramite", b =>
                {
                    ...
                    b.Property<DateTime>("Fecha")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 12, 4, 10, 33, 4, 822, DateTimeKind.Local).AddTicks(3761));
