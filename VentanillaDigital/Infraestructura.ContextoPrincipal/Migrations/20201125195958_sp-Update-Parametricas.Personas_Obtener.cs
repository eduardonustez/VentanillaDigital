...
{
    public partial class spUpdateParametricasPersonas_Obtener : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2020, 11, 25, 14, 55, 35, 56, DateTimeKind.Local).AddTicks(9280));
...
END");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2020, 11, 25, 14, 55, 35, 56, DateTimeKind.Local).AddTicks(9280),
                oldClrType: typeof(DateTime),
