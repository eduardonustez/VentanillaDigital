...
{
    public class ConvenioRNECRepositorio : RepositorioBase<ConvenioRNEC>, IConvenioRNECRepositorio
    {
        #region Miembros
        ...
        #region Constructor
        public ConvenioRNECRepositorio(UnidadTrabajo unidadTrabajoContextoPrincipal) : base(unidadTrabajoContextoPrincipal)
        {
