...
{
    public class ActoPorTramiteRepositorio : RepositorioBase<ActoPorTramite>, IActoPorTramiteRepositorio
    {
        #region Miembros
        ...
        public ActoPorTramiteRepositorio(UnidadTrabajo unidadTrabajoContextoPrincipal,
