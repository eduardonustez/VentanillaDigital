...
{
    public class RecaudoTramiteVirtualRepositorio : RepositorioBase<RecaudoTramiteVirtual>, IRecaudoTramiteVirtualRepositorio
    {
        #region Miembros
        ...
        #region Constructor
        public RecaudoTramiteVirtualRepositorio(UnidadTrabajo unidadTrabajoContextoPrincipal,
