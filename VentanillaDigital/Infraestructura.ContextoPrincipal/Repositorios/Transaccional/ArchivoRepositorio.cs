...
namespace Infraestructura.ContextoPrincipal.Repositorios.Transaccional
{
    public class ArchivoRepositorio : RepositorioBase<Archivo>, IArchivoRepositorio
    {
        ...
        public ArchivoRepositorio(UnidadTrabajo unidadTrabajoContextoPrincipal, IHttpContextAccessor httpContext) : base(unidadTrabajoContextoPrincipal, httpContext)
        {
